...
# agent class with an id, move rate, sensor range, in a node in an enviroment
# an agent knows the envirnment it is in, what an agent about he environment
# is mutable 
class Agent:
...
def find_path(the_agent, the_environment, to_visit, option):
    ...
    if option == "random":
        ...
        while (len(to_visit) > 0):
            ...
            # move agent with least serached algorithm
